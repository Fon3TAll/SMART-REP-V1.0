  ...
  return (
    <div className="relative flex min-h-screen w-full font-mono bg-slate-900 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url('https://www.nstda.or.th/nac/2024/wp-content/uploads/2024/03/Main-bcg03_shutterstock_1807239847.webp')`
        }}
      />
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <p className="max-w-md text-[15px] leading-relaxed text-white/80 font-medium">
                Streamline your operations, optimize resource management,<br />
                and take full control of your business lifecycle with<br />
                our advanced ERP platform.<br />
              </p>
