  ...
  return (
    <header className="bg-transparent border-b border-slate-200/50 px-6 py-3 flex justify-between items-center z-10">
      ...
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 rounded-md relative shrink-0 flex items-center justify-center shadow-sm">
          ...
          <Settings size={20} className="text-white relative z-10 drop-shadow-md" strokeWidth={2.5} />
        </div>
